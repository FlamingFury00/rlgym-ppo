...
class SegmentTree:
    def __init__(self, capacity, operation, neutral_element):
        ...
        b) User has access to an efficient reduce operation which reduces operation over
           a contiguous subsequence of items in the array.

        :param capacity: Total size of the array - must be a power of two.
        :param operation: The operation for combining elements (e.g. sum, max)
        :param neutral_element: The neutral element for the operation above. (e.g. 0 for sum, inf for max)
        """
        assert (
...
class SumSegmentTree(SegmentTree):
    ...
    def find_prefixsum_idx(self, prefixsum):
        ...
        :param prefixsum: upper bound on the sum of array prefix
